...
function addProduct(product) {
  axios
    .post(
      "https://crudcrud.com/api/2c69671bfa5141d1b2819c6cfe951ff1/sellerPageData",
      product
    )
    .then((res) => {
...
function deleteProducts(product) {
  axios
    .delete(
      `https://crudcrud.com/api/2c69671bfa5141d1b2819c6cfe951ff1/sellerPageData/${product._id}`
    )
